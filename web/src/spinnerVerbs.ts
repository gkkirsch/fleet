// Copied from claude-code-internals src/constants/spinnerVerbs.ts so the
// fleetview "thinking" indicator uses the same vocabulary Claude Code
// shows in its TUI. Add a little flavor while an agent is streaming.
